...
void CCrosshair::DrawBorder(New3D::Mat4 matrix, bool wide)
{
    glDisable(GL_BLEND);
    m_shader.EnableShader();
    std::vector<CCrosshair::BasicVertex> verts;

    float vb = 0.0f, b = 0.0f, hb = 0.0f;
    ...
    b = float(0.022f + hb); //top
    verts.emplace_back(0.0f, b);
    verts.emplace_back(0.0f, 0.0f);
    verts.emplace_back(1.0f, 0.0f);
    verts.emplace_back(1.0f, 0.0f);
    verts.emplace_back(1.0f, b);
    verts.emplace_back(0.0f, b);
    b = float(0.984f - vb); //right
    verts.emplace_back(b, 1.0f);
    verts.emplace_back(b, 0.0f);
    verts.emplace_back(1.0f, 0.0f);
    verts.emplace_back(1.0f, 0.0f);
    verts.emplace_back(1.0f, 1.0f);
    verts.emplace_back(b, 1.0f);
    b = float(0.978f - hb); //bottom
